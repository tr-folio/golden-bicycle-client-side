                ...
                <Row className="d-flex">
                    <Col xs="12" lg="4">
                        ...
                        <p className="text-info text-start">
                            ...
                            <i className="fab fa-twitter fs-3 me-3"></i>
                        </p>
                    </Col>
                    <Col xs="12" lg="4">
                    ...
                    <Col xs="12" lg="4">
                        <h3 className="text-light text-lg-end mb-3">Contact Us</h3>
                        <p className="text-info text-lg-end">Email: abc@example.com</p>
                        <p  className="text-info text-lg-end">Phone: 22222222</p>
                    </Col>
                </Row>
            </Container>
        </div>
